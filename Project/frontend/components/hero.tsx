...
export default function Navbar() {
  ...
  return (
    <header className="fixed top-0 left-0 w-full z-50 backdrop-blur-md bg-gradient-to-r from-[#FFEDDB] via-[#2d3e3e] to-[#242e2d] border-b border-[#adc2d3]/25 shadow-[0_4px_25px_rgba(0,0,0,0.4)] transition-all duration-500">
      <div className="max-w-7xl mx-auto flex items-center justify-between px-6 sm:px-10 py-4">

        {/* Brand */}
        <Link href="/" className="flex items-center gap-2 group">
          <div className="h-10 w-10 rounded-xl bg-gradient-to-br from-[#FFEDDB] to-[#adc2d3] flex items-center justify-center shadow-[0_0_10px_rgba(173,194,211,0.5)]">
